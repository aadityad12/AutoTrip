...
export type RootStackParamList = {
  Home: undefined;
  Results: { tripData: any[]; totalCost: number; destination: string; duration: string };
  Payment: { tripData: any[]; totalCost: number; destination: string; duration: string; tripId: string };
  Confirmation: { tripData: any[]; totalCost: number; destination: string; duration: string; tripId: string };
};
